...
<div class="form-group">
  ...
  <div class="col-xs-6">
  <input id="lrn" name="lrn" type="text" placeholder="Enter Reg " maxlength="12" class="form-control input-xs" required="">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="form-group">
    <label class="col-xs-2 control-label" for="sy">School Year Completed</label>
  ...
  <div class="form-group">
  <label class="col-xs-2 control-label" for="tn">Years Attended</label> 
  <br>
  <div class="col-xs-6">
...
<div class="form-group">
  <label class="col-xs-2 control-label" for="ave">KCSE</label> 
  <div class="col-xs-6">
