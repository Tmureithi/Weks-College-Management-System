...
<div style="margin-left:.5in;margin-right:.5in;margin-top:.1in;margin-bottom:.1in;line-height:1mm;">
		...
		<p><center><b>WEKS COLLEGE</b></center></p>

		  </div>
		  <div class="row">
		  <div class="col-md-12">
		  <center><p><b><h4>STUDENT'S TRANSCRIPTS</h4></b></p></center>
		  </div>
          </div>
          <div class="row">
		  <div class="col-md-12">
		...
		?>
			<tr>
				...
				<td style="width:600px;font-size:12px">
				<label for="">Current Date:&nbsp&nbsp&nbsp&nbsp&nbsp</label>
			...
			<td style="width:800px;font-size:12px">
					...
					<label for="">Previous School:&nbsp</label>
			...
			<td style="width:200px;font-size:12px">
				<label for="">KSCE/A-LEVEL:&nbsp</label>
		...
		<label style="font-size:12px">Sem & Yr:&nbsp&nbsp&nbsp&nbsp&nbsp
					<?php echo $row1['grade'] . '-' . $row1['SECTION']  ?></label>
		</td>
		<td >
		<label style="font-size:12px">Aca.Yr.:&nbsp&nbsp&nbsp&nbsp&nbsp
		...
		<tr>
		<td style="width:150px;border:1px solid black;font-size:12px;"><center><b>Units</b></center></td>
		<td style="width:60px;border:1px solid black;font-size:12px;"><center><b>Mark</b></center></td>
		<td style="width:60px;border:1px solid black;font-size:12px;"><center><b>Credits Earned</b></center></td>
...
<div class="col-md-12">
		...
		?>
		<p class="p" style="text-align:justify;line-height:5mm;font-transform:capitalize"> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp I hereby certify that the above is the true record of &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <?php echo '<u>&nbsp&nbsp&nbsp&nbsp'  . $row['FIRSTNAME'] . ' ' .  substr("$mid", 0, 1) . '. ' . $row['LASTNAME'] . '&nbsp&nbsp&nbsp</u>' . '.' ?> This student is eligible on this &nbsp&nbsp&nbsp <?php echo date("d") . 'th'?> &nbsp&nbsp&nbsp day of &nbsp&nbsp&nbsp <?php echo date("M") . ',' . date("y")?> &nbsp&nbsp&nbsp for admission to &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp year as (regular) student, and has no property responsibility in this college. </p>
				...
				<td style="">
					...
					<tr>
						...
						<td style="width:250px;">
							<center><h5>Antony Wekesa</h5></center>
						</td>
					</tr>
					</table>
				</td>
